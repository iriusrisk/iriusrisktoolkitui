...
def addConditionDetailsToRow(condition, row):
  if condition == "":
    ...
    row.append(condition.get_pattern().get_name())
    row.append(condition.get_pattern().get_pattern())
    row.append(condition.get_type())
...
def addActionDetailsToRow(action, row):
  if action == "":
    ...
    row.append(action.get_pattern().get_name())
    row.append(action.get_pattern().get_pattern())
    row.append(action.get_type())
